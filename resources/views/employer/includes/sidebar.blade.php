<aside id="sidebar" class="fixed top-0 left-0 h-full bg-white border-r border-gray-200 text-gray-700 sidebar-transition z-50 overflow-y-auto overflow-x-hidden shadow-sm"
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <!-- Dashboard -->
            <div class="nav-item">
                <a href="{{ route('employer.dashboard') }}" class="nav-link nav-link-active flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#1a237e] bg-blue-50 hover:bg-blue-100 transition-all duration-200 group">
            ...
            <!-- Jobs -->
            <div class="nav-item">
                <a href="{{ route('employer.jobs.index') }}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
            ...
            <!-- Applications -->
            <div class="nav-item">
                <a href="{{route('employer.applications.index')}}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
            ...
            <!-- Schedule Interview -->
            <div class="nav-item">
                <a href="{{route('employer.applications.interview')}}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
                    <i class="fas fa-file-alt w-5 text-center text-sm text-gray-400 group-hover:text-[#FF7543]"></i>
                    <span class="nav-link-text text-sm font-medium">Schedule Interviews</span>
                    <span class="nav-tooltip">Schedule Interviews</span>
                </a>
            </div>
