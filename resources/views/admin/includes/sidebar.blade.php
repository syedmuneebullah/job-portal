<aside id="sidebar" class="fixed top-0 left-0 h-full bg-white border-r border-gray-200 text-gray-700 sidebar-transition z-50 overflow-y-auto overflow-x-hidden shadow-sm"
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <!-- Dashboard -->
            <div class="nav-item">
                <a href="{{ route('admin.dashboard') }}" class="nav-link nav-link-active flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#1a237e] bg-blue-50 hover:bg-blue-100 transition-all duration-200 group">
            ...
            <!-- Users -->
            <div class="nav-item">
                <a href="{{ route('admin.users.index') }}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
            ...
            <!-- Jobs -->
            <div class="nav-item">
                <a href="{{ route('admin.jobs.index') }}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
            ...
            <div class="nav-item">
                <button onclick="toggleSubMenu('subscriptionsMenu')" class="nav-link flex items-center justify-between gap-3 px-3 py-2.5 w-full rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
                    <div class="flex items-center gap-3">
                        <i class="fas fa-credit-card w-5 text-center text-sm text-gray-400 group-hover:text-[#FF7543]"></i>
                        <span class="nav-link-text text-sm font-medium">Subscriptions</span>
                    </div>
                    <i class="fas fa-chevron-down text-xs text-gray-400 transition-transform duration-200" id="subscriptionsMenuIcon"></i>
                    <span class="nav-tooltip">Subscriptions</span>
                </button>
                
                <!-- Sub-menu -->
                <div id="subscriptionsMenu" class="sub-menu ml-7 mt-1 space-y-1 overflow-hidden transition-all duration-300 max-h-0">
                    <!-- Plans -->
                    <div class="nav-item">
                        <a href="{{ route('admin.subscription-plans.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-gray-500 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group text-sm">
                            <i class="fas fa-list w-5 text-center text-xs text-gray-400 group-hover:text-[#FF7543]"></i>
                            <span class="nav-link-text text-sm font-medium">Plans</span>
                            <span class="nav-tooltip">Plans</span>
                        </a>
                    </div>
                    
                    <!-- User Subscriptions -->
                    <div class="nav-item">
                        <a href="{{ route('admin.subscriptions.index') }}" class="nav-link flex items-center gap-3 px-3 py-2 rounded-lg text-gray-500 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group text-sm">
                            <i class="fas fa-users-cog w-5 text-center text-xs text-gray-400 group-hover:text-[#FF7543]"></i>
                            <span class="nav-link-text text-sm font-medium">User Subscriptions</span>
                            <span class="nav-tooltip">User Subscriptions</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <!-- Companies -->
            <div class="nav-item">
                <a href="{{ route('admin.employers.index') }}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:text-[#1a237e] hover:bg-gray-100 transition-all duration-200 group">
