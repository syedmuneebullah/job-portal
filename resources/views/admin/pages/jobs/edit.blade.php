...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <form action="{{ route('admin.jobs.update', $job->id) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="currency" value="{{ old('currency', $job->currency ?? 'USD') }}" 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="recruiter_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all">
                        ...
                        @foreach($recruiters as $recruiter)
                            <option value="{{ $recruiter->id }}" {{ old('recruiter_id', $job->recruiter_id) == $recruiter->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="visibility" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all" required>
                        ...
                        <option value="internal" {{ old('visibility', $job->visibility) == 'internal' ? 'selected' : '' }}>Internal</option>
                    </select>
                </div>
                ...
                <div>
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="is_ai_generated" value="1" {{ old('is_ai_generated', $job->is_ai_generated) ? 'checked' : '' }}
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="datetime-local" name="published_at" value="{{ old('published_at', $job->published_at?->format('Y-m-d\TH:i')) }}" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Closing Date</label>
                        <input type="datetime-local" name="closing_at" value="{{ old('closing_at', $job->closing_at?->format('Y-m-d\TH:i')) }}" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max_applications" value="{{ old('max_applications', $job->max_applications) }}" 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
        ...
        <div class="space-y-4 mt-4">
            ...
            <div>
                ...
                <textarea name="description" rows="6" 
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
                          placeholder="Job description..." required>{{ old('description', $job->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="requirements" rows="4" 
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
                          placeholder="Job requirements...">{{ old('requirements', $job->requirements) }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" name="required_skills" value="{{ old('required_skills', is_array($job->required_skills) ? implode(', ', $job->required_skills) : $job->required_skills) }}" 
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
            ...
            <div>
                ...
                <input type="text" name="preferred_skills" value="{{ old('preferred_skills', is_array($job->preferred_skills) ? implode(', ', $job->preferred_skills) : $job->preferred_skills) }}" 
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
            ...
            <div>
                ...
                <input type="text" name="education_requirement" value="{{ old('education_requirement', $job->education_requirement) }}" 
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#1a237e] focus:ring-2 focus:ring-[#1a237e]/20 outline-none transition-all"
        ...
        <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
            ...
            <a href="{{ route('admin.jobs.index') }}" class="px-6 py-2.5 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-all duration-200">
                Cancel
            </a>
        </div>
    </form>
