...
class ApplicantCertificate extends Model
{
    ...
    /**
     * Get the user that owns the certificate record.
     */
    ...
    /**
     * Scope a query to only include ongoing certificates.
     */
    ...
    /**
     * Scope a query to search by title or institute.
     */
    public function scopeSearch($query, $search)
    {
        if ($search) {
            return $query->where(function($q) use ($search) {
                $q->where('sertification_title', 'LIKE', "%{$search}%")
    ...
    /**
     * Get the formatted duration of certificate.
     */
    ...
    /**
     * Get the certificate title with institute name.
     */
    public function getFullTitleAttribute()
    {
        $title = $this->sertification_title ?? 'Certificate';
        
        if ($this->institute_name) {
            $title .= ' from ' . $this->institute_name;
        }
    ...
    /**
     * Check if the certificate is ongoing.
     */
    ...
    /**
     * Get formatted certificate period for display.
     */
    ...
    /**
     * Get the certificate title (alias for sertification_title).
     */
    public function getTitleAttribute()
    {
        return $this->sertification_title;
    }
